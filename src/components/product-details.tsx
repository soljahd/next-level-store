        ...
        >
          ...
          >
            ...
            >
              <IconButton
                onClick={() =>
                  changeImageIndex(displayedImageIndex === 0 ? images.length - 1 : displayedImageIndex - 1)
                }
                sx={{
                  position: 'absolute',
                  top: '50%',
              ...
              <IconButton
                onClick={() =>
                  changeImageIndex(displayedImageIndex === images.length - 1 ? 0 : displayedImageIndex + 1)
                }
                sx={{
                  position: 'absolute',
                  top: '50%',
